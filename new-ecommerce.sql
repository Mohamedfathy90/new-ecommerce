...
(1, 'Admin', 'admin', '/storage/profile_images/admin//img_1687202455.jpg', NULL, 'admin@gmail.com', 'admin', 'active', NULL, '$2y$10$/5cFN9L6uWP8hzq.bLvly.cXbQm2RkiSSINFnfF0YEdX8YiQxtPWO', '2bE8qVtmU8VxJ6Bt95v109uHX6l0PcQzx8KuMeVqrMQaeRSODs0LdpDjzXwZ', '2023-06-07 14:25:22', '2023-06-19 17:20:55'),
...
CREATE TABLE `vendors` (
  ...
  `inst_link` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `vendors` (`id`, `user_id`, `banner`, `name`, `email`, `phone`, `address`, `description`, `fb_link`, `tw_link`, `inst_link`, `created_at`, `updated_at`) VALUES
(1, 1, 'bbbbbbbb', 'Admin Shop', 'admin@gmail.com', '010118688355', '24 Seif Street , Sidi-Bishr', 'welcome to our store', NULL, NULL, NULL, NULL, '2023-07-04 09:11:42'),
(2, 2, '', 'Vendor', 'vendor@gmail.com', '555555555', 'kkkkkkkkkkk', 'mmmmmmmmmmmm', NULL, NULL, NULL, NULL, NULL);
