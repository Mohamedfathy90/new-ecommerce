...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 01, 2023 at 01:18 AM
...
INSERT INTO `products` (`id`, `thumbnail`, `name`, `description`, `vendor_id`, `childcategory_id`, `brand_id`, `sku`, `qty`, `price`, `offer_price`, `offer_start_date`, `offer_end_date`, `is_top`, `is_best`, `is_featured`, `is_approved`, `status`, `created_at`, `updated_at`) VALUES
(1, 'gggggggggggggggg', 'Vertical Mouse', 'this ne vertical mouse', 1, 3, 1, 'SAA666', 50, 500, NULL, NULL, NULL, 0, 0, 0, 'pending', 'active', NULL, NULL);
