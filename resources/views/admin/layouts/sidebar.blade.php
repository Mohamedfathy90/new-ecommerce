<div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
            <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-columns"></i> <span>Manage Categories
            </span></a>
            <ul class="dropdown-menu" >
              <li><a href="/admin/category">Main Categories</a></li>
              <li><a  href="/admin/subcategory">Sub Categories</a></li>
              <li><a  href="/admin/childcategory">Child Categories</a></li>
            </ul>
          </li>
